...
//       let basePrice = parseInt(pizzaSize.value);
//       let extraToppings = 0;

//       toppings.forEach(topping => {
//           if (topping.checked) {
//               extraToppings += parseInt(topping.value);
//           }
//       });

//       priceDisplay.textContent = basePrice + extraToppings;
//   }

//   pizzaSize.addEventListener("change", updatePrice);
